...
import type { Simplify } from '../../src/types';
import type { AnyRootConfig, RootConfig } from '../../src/core/internals/config';
import type { ParseFn } from '../../src/core/internals/getParseFn';
import type { ProcedureBuilderMiddleware } from '../../src/core/internals/procedureBuilder';
import type { DefaultValue, MiddlewareMarker, Overwrite, UnsetMarker } from '../../src/core/internals/utils';
import type { ProcedureParams } from '../../src/core/procedure';
import type { ProcedureType } from '../../src/core/types';
/**
 * @internal
 */
 ...
 * @internal
 */
export type MiddlewareResult<TParams extends ProcedureParams> = MiddlewareErrorResult<TParams> | MiddlewareOKResult<TParams>;
/**
 * @internal
 */
 ...
 */
type CreateMiddlewareReturnInput<TRoot extends ProcedureParams, TPrev extends ProcedureParams, TNext extends ProcedureParams> = MiddlewareBuilder<TRoot, {
 ...
 * @internal
 */
export declare function createMiddlewareFactory<TConfig extends AnyRootConfig, TInputIn = unknown>(): <TNewParams extends ProcedureParams<AnyRootConfig, unknown, unknown, unknown, unknown, unknown, unknown>>(fn: MiddlewareFunction<deriveParamsFromConfig<TConfig, TInputIn>, TNewParams>) => MiddlewareBuilder<deriveParamsFromConfig<TConfig, TInputIn>, TNewParams>;
export declare const experimental_standaloneMiddleware: <TCtx extends {
    ctx?: object | undefined;
    meta?: object | undefined;
    input?: unknown;
}>() => {
    create: <TNewParams extends ProcedureParams<AnyRootConfig, unknown, unknown, unknown, unknown, unknown, unknown>>(fn: MiddlewareFunction<deriveParamsFromConfig<RootConfig<{
        ctx: TCtx extends {
