...
import type { inferTransformedProcedureOutput } from '../../src/shared/jsonify';
import type { AnyProcedure, ProcedureArgs } from '../../src/core/procedure';
import type { AnyRouter, AnyRouterDef, Router } from '../../src/core/router';
export type inferRouterDef<TRouter extends AnyRouter> = TRouter extends Router<infer TParams> ? TParams extends AnyRouterDef<any> ? TParams : never : never;
export type inferRouterContext<TRouter extends AnyRouter> = inferRouterDef<TRouter>['_config']['$types']['ctx'];
export type inferRouterError<TRouter extends AnyRouter> = inferRouterDef<TRouter>['_config']['$types']['errorShape'];
export type inferRouterMeta<TRouter extends AnyRouter> = inferRouterDef<TRouter>['_config']['$types']['meta'];
 ...
 */
export type inferSubscriptionOutput<TRouter extends AnyRouter, TPath extends string & keyof TRouter['_def']['subscriptions']> = inferObservableValue<inferProcedureOutput<TRouter['_def']['subscriptions'][TPath]>>;
export type inferProcedureClientError<TProcedure extends AnyProcedure> = inferProcedureParams<TProcedure>['_config']['errorShape'];
