import type { ProcedureParams, ProcedureType } from '../../src';
import type { AnyRootConfig, RootConfig } from '../../src/core/internals/config';
import type { Procedure } from '../../src/core/procedure';
import type { Router as NewRouter, RouterDef } from '../../src/core/router';
import type { AnyRouter as AnyOldRouter, Router as OldRouter } from '../../src/deprecated/router';
import type { TRPCErrorShape } from '../../src/rpc';
import type { CombinedDataTransformer } from '../../src/transformer';
import type { Procedure as OldProcedure } from '../../src/deprecated/internals/procedure';
import type { ProcedureRecord } from '../../src/deprecated/router';
